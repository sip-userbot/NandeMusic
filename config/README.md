# Nande Music Bot Configs

Config vars are basically the variables which configure or modify bot to function, which are the basic necessities of plugins or code to work. You have to set the proper mandatory vars to make it functional and to start the basic feature of bot.

### Get to know about all these vars in depth from our Docs. [Read Now from Here](https://notreallyshikhar.gitbook.io/NandeMusicbot/config-vars/available-vars)
...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@NandeStringBot](http://t.me/NandestringBot) in Telegram.
...
- If you plan to use Nande Music Bot with your own customized or modified code.
...
- You can change images which are used in Nande Music Bot.
- You can generate telegaph links from [@Nanderobot](http://t.me/Nanderobot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@NandestringBot](http://t.me/NandestringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@NandestringBot](http://t.me/NandestringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@NandestringBot](http://t.me/NandestringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@NandestringBot](http://t.me/NandestringBot) in Telegram.
