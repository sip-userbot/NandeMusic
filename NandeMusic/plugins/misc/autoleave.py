...
from NandeMusic.core.call import Nande, autoend
from NandeMusic.utils.database import (get_client, is_active_chat,
                                       is_autoend)
                    ...
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in [
                            ...
                            if (
                                ...
                                and chat_id != -1001747328888
                                and chat_id != -1001726206158
                            ):
