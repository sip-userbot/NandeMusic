#
# Copyright (C) 2021-2022 by TeamNands@Github, < https://github.com/TeamNande >.
#
...
from NandeMusic.utils.database import get_authuser_names, get_cmode
from NandeMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from NandeMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Nande.stop_stream(message.chat.id)
    except:
        pass
